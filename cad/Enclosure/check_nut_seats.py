...
d=A.openDocument(str(r/'Enclosure.FCStd'));V=A.Vector
checks={};nuts=[]
...
for x,y in p['closure_screw_xy']:
 ...
 nuts.append(entry)
report={'revision':'v1.0','nuts':nuts,'nut_proxy':{'across_flats_mm':4,'height_mm':1.6},'all_six_have_complete_walls_seats_and_caps':True}
(r/'nut-seats-v1.0-validation.json').write_text(json.dumps(report,indent=2)+'\n');print(json.dumps(report,indent=2))
