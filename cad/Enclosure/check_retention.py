"""Geometric regression for the independent v1.0 connector retention."""
...
result={'revision':'v1.0','checks':checks,'retention_checks':retention,'physical_fit_verified':False,'console_scan_axial_clearance':'Not checked by this script; embedded scans are display references only.'}
