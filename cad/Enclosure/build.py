...
for name in ['ConsoleTop','ConsoleBottom']:
 ...
 if source:
  o=D.addObject('Mesh::Feature',name);o.Mesh=source.Mesh.copy()
  o.Placement=source.Placement;scans.addObject(o)
  if A.GuiUp:o.ViewObject.Visibility=False
A.closeDocument(reference.Name)
