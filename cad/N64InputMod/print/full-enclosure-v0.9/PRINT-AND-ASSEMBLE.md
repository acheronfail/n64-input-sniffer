...
Rear-board-stop revision: its 1.6 mm thick wall is moved 0.8 mm away from the USB end. The low foundation extends with it to retain the connection. Board pocket length gains 0.8 mm; all other print parts and nut-pause geometry are unchanged.
