# N64InputMod v0.14 — independently retained ports

Use the [print-ready OrcaSlicer 3MF](../../N64InputMod-full-enclosure-v0.14-Orca-complete.3mf). It includes all 12 parts and checked G-code across three plates, using the existing Bambu Lab P1S 0.4 mm profile, 0.16 mm layers and a 0.20 mm first layer:
