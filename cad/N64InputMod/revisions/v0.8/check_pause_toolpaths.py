...
with zipfile.ZipFile(r/'N64InputMod-full-enclosure-v0.8-Orca-complete.3mf') as z:
 settings=json.loads(z.read('Metadata/project_settings.config'))
ox,oy=map(float,settings['extruder_offset'][0].split('x'))
yoff=140+(min(ys)+max(ys))/2-oy
centres={}
for i,x in enumerate([-63.7,-36,36,63.7]):centres['M3_'+str(i)]=(128+x-ox,yoff-(7+x*x/1450-23),1.95,2.5)
for i,(x,y) in enumerate([(-77,-39),(77,-39),(-19,-19),(19,-19),(-79,-18),(79,-18)]):centres['M2_'+str(i)]=(128+x-ox,yoff-y,1.35,1.75)
