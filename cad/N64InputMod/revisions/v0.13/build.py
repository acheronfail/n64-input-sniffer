...
for i,fx in enumerate(P['port_x']):
 ...
 collars.extend([box(x-13.6,-28+bow(fx),-13.6,27.2,21.5,27.2),box(fx-13.2,fr,bz+wall,26.4,19,13.6-(bz+wall))])
...
for i,x in enumerate(P.get('male_port_x',P['port_x'])):
 cy_m=P['nose_y']+bow(P['port_x'][i])-23.0
...
D.saveCopy(str(ROOT/'N64InputMod-v0.13.FCStd'))
