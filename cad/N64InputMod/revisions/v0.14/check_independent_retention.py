"""Geometric regression for the independent v0.14 connector retention."""
...
result={'revision':'v0.14','checks':checks,'retention_checks':retention,'physical_fit_verified':False,'console_scan_axial_clearance':'See console-retention-fit.json: extended mating envelopes checked separately under the explicitly revised scan registration; installed socket depth remains unverified.'}
