# N64InputMod — console-facing USB prototype v0.12

Open [N64InputMod.FCStd](N64InputMod.FCStd) in FreeCAD. A versioned copy is saved as `N64InputMod-v0.12.FCStd`. The shrouded v0.11 model and sources are preserved in `revisions/v0.11/`; the older v0.10 files also remain available.
