...
r=Path(__file__).parent;lines=Path('/tmp/n64-v011-slice/plate_1.gcode').read_text().splitlines()
...
with zipfile.ZipFile(r/'N64InputMod-full-enclosure-v0.11-Orca-complete.3mf') as z:
