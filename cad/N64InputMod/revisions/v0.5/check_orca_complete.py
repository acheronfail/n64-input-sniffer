...
base=Path('/home/acheronfail/src/freecad-n64-input/N64InputMod');p=base/'N64InputMod-full-enclosure-v0.5-Orca-complete.3mf'
...
with zipfile.ZipFile(p) as z:
 ...
 (base/'orca-v0.5-validation.json').write_text(json.dumps(result,indent=2)+'\n');print(result)
