...
# Drop the front seam through the USB centre. The upper tongue contains the
# upper half of the opening; both shell halves now have open-ended notches.
# Clearance on both vertical shoulders and the horizontal landing is 0.16 mm.
...
bc=feature('BoardFitCoupon',base.common(box(-18,fr-1,-17,36,(usby+L+3)-(fr-1),26)),hist)
