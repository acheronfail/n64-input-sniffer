# N64InputMod — full enclosure prototype v0.10
...
## Current full enclosure print set

Use [the v0.10 print set and assembly guide](print/full-enclosure-v0.10/PRINT-AND-ASSEMBLE.md) or `N64InputMod-full-enclosure-v0.10-Orca-complete.3mf`. Both shells need reprinting. The keeper, four rigid shoes, four TPU pads and optional window can be reused. Closure uses six M2 x 20 flat-head screws and embedded M2 nuts; clamps use four M3 x 8 flat-head screws and embedded M3 nuts. The keeper uses two normal M2 x 8 plastic screws.

v0.10 extends the enclosure forward by 10 mm, targeting approximately 25 mm minimum wiring space based on the owner's measurements. The female ports, ESP mount, USB opening and LED window move together; the male mating positions stay fixed. All four inward-facing male tail saddles are cut 1.25 mm deeper (option A). The previously added 0.8 mm ESP rear-stop clearance is retained.

Geometry regression checks confirm the 10 mm extension, 1.25 mm recess change and unchanged male mating positions. OrcaSlicer 2.4.2 successfully sliced plate 1 without reported warnings. Both embedded-nut pauses remain before layers 34 and 88, and toolpaths confirm all ten pocket caps begin after the corresponding pause. Physical fit of these revised shells remains to be checked.
