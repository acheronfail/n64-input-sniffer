...
base=Path('/home/acheronfail/src/freecad-n64-input/N64InputMod');p=base/'N64InputMod-full-enclosure-v0.10-Orca-complete.3mf'
...
with zipfile.ZipFile(p) as z:
 ...
 lo,hi=bounds[keeper.get('id')];assert md(keeper,'extruder')=='1'
 ...
 result={'parts':len(bounds),'plate_counts':[7,4,1],'bed_bounds_and_no_overlap':True,'keeper_size_mm':[hi[k]-lo[k] for k in range(3)],'orca_import_export':'passed'}
 (base/'orca-v0.10-validation.json').write_text(json.dumps(result,indent=2)+'\n');print(result)
